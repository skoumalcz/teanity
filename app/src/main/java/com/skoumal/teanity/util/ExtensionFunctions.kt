...
fun AppCompatActivity.snackbar(view: View,
...
fun Fragment.snackbar(view: View,
                      @StringRes messageRes: Int,
                      length: Int = Snackbar.LENGTH_SHORT,
                      f: Snackbar.() -> Unit = {}) {
    snackbar(view, getString(messageRes), length, f)
...
fun Snackbar.action(@StringRes actionRes: Int,
                    @ColorRes colorRes: Int? = null,
                    listener: (View) -> Unit) {
    action(view.resources.getString(actionRes),
...
fun <T : ViewDataBinding> Fragment.inflateBindingView(inflater: LayoutInflater,
                                             @LayoutRes layoutResId: Int,
                                             parent: ViewGroup?,
                                             attachToParent: Boolean): T {
                ...
                override fun onPermissionDenied(response: PermissionDeniedResponse) {
                    ...
                    if (response.isPermanentlyDenied) {
                        snackbar(view, explanation, Snackbar.LENGTH_LONG) {
                            ...
                            action("Settings") {
                                val appSettings = Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS, "package:$packageName".toUri()).apply {
...
fun AppCompatActivity.requestPermissionSoft(permission: String, onGranted: () -> Unit, onDenied: () -> Unit) {
    Dexter.withActivity(this)
            ...
            .withListener(object: PermissionListener {
                ...
                override fun onPermissionDenied(response: PermissionDeniedResponse) { onDenied() }
